...
/**
 * Bubble is not in use at this time as one must decide on extending Fragent or AppCompat.
 * Regardless, BubbleView Method cannot take parameters even though it is not giving an error.
 */
